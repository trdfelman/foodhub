...
//be followed.
    ...
    define('select2/compat/query', [], function () {
    ...
    define('select2/dropdown/attachContainer', [], function () {
    ...
    define('select2/dropdown/stopPropagation', [], function () {
    ...
    define('select2/selection/stopPropagation', [], function () {
        function StopPropagation() {
        }
