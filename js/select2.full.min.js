!function () {
    ...
    if (window.jQuery && jQuery.fn && jQuery.fn.select2 && jQuery.fn.select2.amd)var a = jQuery.fn.select2.amd.define, b = jQuery.fn.select2.amd.require;
    var c, b, a;
    !function (d) {
        function e(a, b) {
            return u.call(a, b)
        ...
        "function" == typeof a && a.amd ? a("jquery.mousewheel", ["jquery"], b) : "object" == typeof exports ? module.exports = b : b(jQuery)
    }(function (a) {
        function b(b) {
    ...
    }), a("select2/compat/matcher", ["jquery"], function (a) {
        function b(b) {
            function c(c, d) {
                var e = a.extend(!0, {}, d);
        ...
        return b
    }), a("select2/compat/initSelection", ["jquery"], function (a) {
        function b(a, b, c) {
    ...
    }), a("select2/compat/inputData", ["jquery"], function (a) {
        function b(a, b, c) {
            this._currentData = [], this._valueSeparator = c.get("valueSeparator") || ",", "hidden" === b.prop("type") && console && console.warn && console.warn("Select2: Using a hidden input with Select2 is no longer supported and may stop working in the future. It is recommended to use a `<select>` element instead."), a.call(this, b, c)
        }
    ...
    }), a("select2/compat/query", [], function () {
        function a(a, b, c) {
            window.console && console.warn && console.warn("Select2: The `query` option has been deprecated in favor of a custom data adapter that overrides the `query` method. Support will be removed for the `query` option in future versions of Select2."), a.call(this, b, c)
        }
    ...
    }), a("select2/dropdown/attachContainer", [], function () {
        function a(a, b, c) {
            a.call(this, b, c)
        }
    ...
    }), a("select2/dropdown/stopPropagation", [], function () {
        function a() {
        }
    ...
    }), a("select2/selection/stopPropagation", [], function () {
        function a() {
        }
